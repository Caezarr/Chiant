...
- `datasets/control_vehicle_v1/data.yaml` : export YOLOv8 present, classe `control_vehicle`, images positives et negatives train/valid suffisantes.
- Couverture labels : par defaut, au moins 20% des volumes image attendus doivent avoir une annotation positive `control_vehicle` (`60` train et `10` valid avec les seuils prod).
