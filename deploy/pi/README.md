...
`box-power-check` ecrit `reports/power-check.json`. La jauge batterie/UPS doit etre visible dans `/sys/class/power_supply`, avec un pourcentage et un statut charge/decharge exploitables.
