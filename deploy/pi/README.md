...
`BOX_STATE_PATH` doit rester dans `/var/lib/boring`; si ce fichier devient illisible, la box bloque l'autopaiement avec `payment_skipped_state_corrupt` au lieu de repartir avec un cooldown vide.
