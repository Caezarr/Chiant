...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-398%2F398-brightgreen" alt="Tests">
</p>
...
make test                     # 398 tests doivent passer
...
- Tests pytest (398/398), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (398/398 actuellement) avant tout commit
