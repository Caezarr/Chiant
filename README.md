...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-403%2F403-brightgreen" alt="Tests">
</p>
...
make test                     # 403 tests doivent passer
...
- Tests pytest (403/403), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (403/403 actuellement) avant tout commit
