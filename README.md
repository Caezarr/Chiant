...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-379%2F379-brightgreen" alt="Tests">
</p>
...
make test                     # 379 tests doivent passer
...
- Tests pytest (379/379), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (379/379 actuellement) avant tout commit
