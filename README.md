...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-390%2F390-brightgreen" alt="Tests">
</p>
...
make test                     # 390 tests doivent passer
...
- Tests pytest (390/390), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (390/390 actuellement) avant tout commit
