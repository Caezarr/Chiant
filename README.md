...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-413%2F413-brightgreen" alt="Tests">
</p>
...
make test                     # 413 tests doivent passer
...
- Tests pytest (413/413), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (413/413 actuellement) avant tout commit
