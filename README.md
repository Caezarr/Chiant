...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-377%2F377-brightgreen" alt="Tests">
</p>
...
make test                     # 377 tests doivent passer
...
- Tests pytest (377/377), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (377/377 actuellement) avant tout commit
