...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-387%2F387-brightgreen" alt="Tests">
</p>
...
make test                     # 387 tests doivent passer
...
- Tests pytest (387/387), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (387/387 actuellement) avant tout commit
