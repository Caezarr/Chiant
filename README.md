...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-378%2F378-brightgreen" alt="Tests">
</p>
...
make test                     # 378 tests doivent passer
...
- Tests pytest (378/378), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (378/378 actuellement) avant tout commit
