...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-383%2F383-brightgreen" alt="Tests">
</p>
...
make test                     # 383 tests doivent passer
...
- Tests pytest (383/383), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (383/383 actuellement) avant tout commit
