...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-393%2F393-brightgreen" alt="Tests">
</p>
...
make test                     # 393 tests doivent passer
...
- Tests pytest (393/393), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (393/393 actuellement) avant tout commit
