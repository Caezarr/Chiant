...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-382%2F382-brightgreen" alt="Tests">
</p>
...
make test                     # 382 tests doivent passer
...
- Tests pytest (382/382), CI GitHub Actions, pre-commit hooks
...
- **Tests** : `make test` — doit passer (382/382 actuellement) avant tout commit
